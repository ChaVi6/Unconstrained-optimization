...
def newton(startX, values, e):
    ...
    plot_graph(x1scale, x2scale, scale, x1, x2, 'Метод Ньютона')
    print_table(steps, x1, x2, f, "Метод Ньютона:")

newton(startX, values, e)